        ...
        <div className="row d-flex justify-content-center">
          <div className="container-box col-lg-3 col-md-6 d-flex flex-column justify-content-center align-items-center  ">
            <img
              ...
              alt="commande icon"
            />
            <h4 className="text-center text-dark fs-3">Commande</h4>
            <p>
          ...
          <div className="container-box  col-lg-3 col-md-6 d-flex flex-column justify-content-center align-items-center ">
            <img
              ...
              alt="paiement icon"
            />
            <h4 className="text-center text-dark fs-3">Paiement</h4>
            <p>
          ...
          <div className="container-box col-lg-3 col-md-6 d-flex flex-column justify-content-center align-items-center">
            <img
              ...
              alt="livraison icon"
            />
            <h4 className="text-center text-dark fs-3">Livraison</h4>
            <p>
